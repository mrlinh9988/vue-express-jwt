  ...
  <div class="home">
    ...
    <div class="jumbotron jumbotron-fluid">
      <div class="container">
        ...
        <p class="lead">
          Simple authentication application built with MEVN Stack using Express, Node.js, Vue.js and MongoDB by Codebook
          Inc.
        </p>
      </div>
    </div>
        ...
        <div class="card bg-dark text-white">
          <div class="card-body">
            ...
            <p class="card-text">
              ...
              MongoDB uses JSON-like documents with schemata. MongoDB is developed by MongoDB Inc.
            </p>
      ...
      <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="card bg-danger text-white">
          <div class="card-body">
            ...
            <p class="card-text">
              Vue.js features an incrementally adoptable architecture that focuses on declarative rendering and
              component composition. Advanced features required for complex applications such as routing...
            </p>
